...
void surf (Input IN, inout SurfaceOutput o) {
	...
	half3 splat3 = tex2D (_Splat3, IN.uv_Control*_Tiling3.xy).rgb;
	half3 splat4 = tex2D (_Splat4, IN.uv_Control*_Tiling4.xy).rgb;
	half3 splat5 = tex2D (_Splat5, IN.uv_Control*_Tiling5.xy).rgb;
